...
* Regression: I had to hide the vanilla techs from the technology GUI where you would previously be able to read descriptions of which progressive chains they belong to. See https://forums.factorio.com/viewtopic.php?t=135579 for my bug report against the Factorio modding API to unblock me from turning this back on without awkward workarounds.
