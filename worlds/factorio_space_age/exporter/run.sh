...
AQUILO_ORBIT_START_PATH=$(ls ~/.factorio/mods/aquilo-orbit-start_*.zip)
...
if [ "$starting_planet" = aquilo-orbit ]; then
    cp "$AQUILO_ORBIT_START_PATH" mods/
elif [ -n "$starting_planet" ]; then
